...
<html lang="en">
    <head>
        ...
        <title>LPKA Kelas II Tomohon - <?= $title ?></title>
        ...
        <link rel="stylesheets" href="<?= base_url() ?>ckeditor/samples/css/samples.css">
        <link rel="stylesheets" href="<?= base_url() ?>ckeditor/samples/toolbarconfigurator/lib/codemirror/neo.css">
