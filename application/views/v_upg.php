					...
					<div class="col">
						<div class="breadcrumbs">
							<ul>
								...
								<li>Unit Pengendali Gratifikasi</li>
							</ul>
						</div>
					</div>
				</div>
    ...
    <div class="contact">
		...
		<div class="contact_info_container">
			<div class="container">
				...
				<h2>Selamat Datang di Unit Pengendali Gratifikasi</h2><br>
				</div>
                <div class="col-lg-12"> 
            ...
            echo form_open_multipart('home/upg_add');
            ?>
            ...
            <div class="form-group">
                    <label>Isi Laporan Gratifikasi (wajib)</label>
                    <textarea name="laporan_gratifikasi" class="form-control" id="" cols="30" rows="10" required> </textarea>
            </div>
